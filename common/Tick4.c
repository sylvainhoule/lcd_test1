/*********************************************************************
 *
 *                  Tick Manager for Timekeeping Tick.c
 *
 *********************************************************************
 * FileName:        Tick.c
 * Dependencies:    Timer 0 (PIC18), Timer 1 (PIC32) or Timer 4 (PIC24F, PIC24H, 
 *					dsPIC30F, dsPIC33F)
...
void TickInit(void)
{
	...
	#if defined(__C30__)
		_T4IP = 2;	// Interrupt priority 2 (low)
		_T4IF = 0;
		_T4IE = 1;
	#else
