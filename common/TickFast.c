/*********************************************************************
 *
 *                  Fast Tick Manager for Timekeeping source file TickFast.c
 *
 *********************************************************************
 * FileName:        Tick.c
 ...
 * Le fichier original doit toujours être dans le répertoire suivant: C:\serge\microcontroleur\dsPIC_PIC24\librairie
 *
 *
********************************************************************/
#define __TICK_C
