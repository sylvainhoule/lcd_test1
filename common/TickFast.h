/*********************************************************************
 *
 *          Fast Tick Manager for Timekeeping source file TickFast.h
 *
 *********************************************************************
 * FileName:        Tick.h
 * Dependencies:    None
 ...
 * Nilesh Rajbharti     5/22/02 Rev 2.0 (See version.log for detail)
  * Serge Hould			1/12/16		Change prescaler for higher frequency tick (8 rather than 256)
 ********************************************************************/
#ifndef __TICK_H
#define __TICK_H
...
// a 1:8 prescalar in Tick.c.  If using a 32kHz watch crystal 
// as the time base, modify the Tick.c file to use no prescalar.
#define TICKS_PER_SECOND		((GetPeripheralClock()+128ull)/8ull)	// Internal core clock drives timer
